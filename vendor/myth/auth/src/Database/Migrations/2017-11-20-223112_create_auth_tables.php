...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'profile' => ['type' => 'varchar', 'constraint' => 255, 'default' => 'profile.png'],
            'alamat' => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'kab' => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'no_telp' => ['type' => 'double', 'null' => true],
            'kota' => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
            'prov' => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
